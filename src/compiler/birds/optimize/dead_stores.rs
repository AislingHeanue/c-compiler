    ...
    fn transfer_dead_stores(
        ...
        for instruction in node.instructions.iter_mut().rev() {
            ...
            match &instruction.0 {
                ...
                | BirdsInstructionNode::DoubleToInt(src, _)
                | BirdsInstructionNode::DoubleToUint(src, _)
                | BirdsInstructionNode::IntToDouble(src, _)
                | BirdsInstructionNode::UintToDouble(src, _)
